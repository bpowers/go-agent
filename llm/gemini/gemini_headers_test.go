...
func TestGemini_HeaderConfiguration(t *testing.T) {
	t.Parallel()
...
func TestGemini_HeadersPersistence(t *testing.T) {
	t.Parallel()
...
func TestGemini_HeadersWithOtherOptions(t *testing.T) {
	t.Parallel()
	...
	require.True(t, ok)
	assert.Equal(t, "https://custom.gemini.com/v1", baseValidator.BaseURL())
}
